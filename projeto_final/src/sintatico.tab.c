...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LCOLCH = 24,                    /* LCOLCH  */
  YYSYMBOL_RCOLCH = 25,                    /* RCOLCH  */
  YYSYMBOL_LCHAVE = 26,                    /* LCHAVE  */
  YYSYMBOL_RCHAVE = 27,                    /* RCHAVE  */
  YYSYMBOL_NUM = 28,                       /* NUM  */
  YYSYMBOL_ID = 29,                        /* ID  */
  YYSYMBOL_FIM = 30,                       /* FIM  */
  ...
  YYSYMBOL_fator = 34,                     /* fator  */
  YYSYMBOL_termo = 35                      /* termo  */
};
...
static const char *const yytname[] =
{
  ...
  "RETURN", "INT", "VOID", "ASSIGN", "EQ", "LTE", "LT", "GTE", "GT",
  "DIFF", "PLUS", "MINUS", "TIMES", "OVER", "LPAREN", "RPAREN", "COLON",
  "SEMI", "LCOLCH", "RCOLCH", "LCHAVE", "RCHAVE", "NUM", "ID", "FIM",
  "ERROR", "$accept", "command", "fator", "termo", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* command: fator  */
#line 20 "sintatico.y"
                {print_tree(yyvsp[0]);}
#line 1165 "sintatico.tab.c"
    break;

  case 3: /* fator: termo PLUS fator  */
#line 22 "sintatico.y"
                         {
                yyval = create_new_node('+', OP_NODE);
...
#line 1175 "sintatico.tab.c"
  ...
  case 4: /* fator: termo MINUS fator  */
#line 27 "sintatico.y"
                            {
                yyval = create_new_node('-', OP_NODE);
                yyval->children[0] = yyvsp[-2];
...
#line 33 "sintatico.y"
            {
                ...
                yyval = create_new_node(atoi(yytext), NUM_NODE);
